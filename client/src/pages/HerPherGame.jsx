              ...
              {qData.isSample && (
                <div style={{ marginTop: 'auto', display: 'flex', width: '100%', position: 'relative', height: '60px' }}>
                  <button 
                    ...
                    style={{ opacity: showControls ? 1 : 0.5, cursor: showControls ? 'pointer' : 'not-allowed', position: 'absolute', left: -20, bottom: 0 }}
                  >
                    Retake Sample
                  </button>
                  <button 
                    ...
                    disabled={!showControls}
                    style={{ opacity: showControls ? 1 : 0.5, cursor: showControls ? 'pointer' : 'not-allowed', position: 'absolute', right: -20, bottom: 0 }}
                  >
                    Start Game
                  </button>
                </div>
