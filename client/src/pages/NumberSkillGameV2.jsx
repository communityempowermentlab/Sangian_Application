...
const NumberSkillGameV2 = () => {
  ...
  const { getAudioUrl, ready: audioReady } = useTestAudio('numeracy_number_skill_v2');
    ...
    <div className="ns-app">
      <header className="ns-topbar">
        <div className="ns-brand">
          ...
          {showGameName && <span className="ns-test-title">{t('home.games.numeracy.title')}{t('common.version2')}</span>}
        </div>
      ...
      {!isCheckingSession && (
        <audio
          ref={audioRef}
          src={getAudioUrl('splash', '/assets/audios/number_skill_v2/splash.wav')}
          preload="auto" 
