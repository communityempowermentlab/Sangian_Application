...
const { adminRouter: audioElementAdminRoutes, publicRouter: audioElementPublicRoutes } = require('./src/routes/audioElementRoutes');
...
app.use('/api/admin/audio-elements',  requireModuleAccess('elements'), audioElementAdminRoutes);
app.use('/api/public/audio-elements', audioElementPublicRoutes);
